            ...
            <div className='veg_home' id='fruits'>
                <div className='veg_main_heading'>
                    ...
                    <div className='container'>
                        ...
                        <p className='flex md:w-[10%] gap-3 md:pl-6 pl-2 items-center pb-4 hover:duration-500 hover:text-yellow-300 transition-all cursor-pointer' onClick={() => { navigate(`/allfruits/Raices`); window.scrollTo(0, 0) }}>View All <FontAwesomeIcon icon={faArrowRight} /> </p>
